...
pub fn Projects() -> impl IntoView {
    ...
    let go_projects = vec![
        Project {
            ...
            description: "A lightweight and blazing-fast backend built with pure Go — no heavy frameworks, just clean and efficient code. Perfect for powering frontend apps that help you track workouts.",
            tech: vec!["Go", "REST API", "Backend"],
            url: "https://github.com/Yeabsirashimelis/workout-tracking-api",
        },
    ];
    ...
    view! {
        <section id="projects" class="projects">
            ...
            <div class="project-tabs">
                ...
                <button
                    class="tab-btn"
                    class:active=move || active_tab.get() == "go"
                    on:click=move |_| set_active_tab.set("go")
                >
                    "go"
                </button>
            </div>
            ...
            <div class="projects-grid" style:display=move || {
                if active_tab.get() == "go" { "flex" } else { "none" }
            }>
                {go_cards}
            </div>
